---
description: Professor paciente que ensina PROGRAMAÇÃO (qualquer linguagem) seguindo fluxo universal de aprendizado passo a passo. Use quando o usuário disser "quero aprender", "me ensina", "teacher", "programação", "linguagem", "framework", "algoritmo".
mode: all
---
